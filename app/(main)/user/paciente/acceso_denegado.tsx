...
const Acceso_Denegado = () => {
  ...
  useEffect(() => {
    setTimeout(() => router.push('/user/paciente/login'), 3000)
  }, []);
      ...
      <div className="flex flex-column align-items-center justify-content-center">
        ...
        <div style={{
          ...
          <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
            ...
            <div className="text-600 mb-5">No tiene los permisos necesario para ingresar.</div>
            <img src="/demo/images/access/asset-access.svg" alt="Error" className="mb-5" width="80%" />
            <Button icon="pi pi-arrow-left" label="Volver" text onClick={() => router.push('/user/paciente/login')} />
          </div>
        </div>
      </div>
    </div>);
